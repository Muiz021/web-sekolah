...
@section('content')
    <main>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-5">
                                <div class="hero-man d-none d-lg-block f-right" data-animation="jello" data-delay=".4s">
                                    <img src="{{ asset('front/img/hero/heroman.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="count-down-area pt-90 pb-60 section-bg"
            data-background="{{ asset('front/img/gallery/section_bg01.png') }}">
            <div class="container">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        ...
                        <div class="single-course mb-40">
                            <div class="course-img">
                                <img src="{{ asset('front/img/gallery/popular_sub1.png') }}" alt="">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        ...
                        <div class="single-course mb-40">
                            <div class="course-img">
                                <img src="{{ asset('front/img/gallery/popular_sub2.png') }}" alt="">
                            </div>
                            <div class="course-caption">
                                <div class="course-cap-top">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        ...
                        <div class="single-course mb-40">
                            <div class="course-img">
                                <img src="{{ asset('front/img/gallery/popular_sub3.png') }}" alt="">
                            </div>
                            <div class="course-caption">
                                <div class="course-cap-top">
        ...
        <div class="testimonial-area fix pt-180 pb-180 section-bg"
            data-background="{{ asset('front/img/gallery/section_bg03.png') }}">
            <div class="container">
                <div class="row justify-content-center">
                        ...
                        <div class="h1-testimonial-active">
                            ...
                            <div class="single-testimonial pt-65">
                                ...
                                <div class="testimonial-icon mb-45">
                                    <img src="{{ asset('front/img/gallery/testimonial.png') }}" class="ani-btn "
                                        alt="">
                                </div>
                                <!-- Testimonial Content -->
