                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <textarea id="text-deskripsi-berita" type="text" name="deskripsi" cols="30" rows="5"
                    ...
                    <form action="{{ route('berita.update', $data->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col mb-3">
                                    <label class="form-label">Deskripsi</label>
                                    <textarea type="text" name="deskripsi" cols="30" rows="5" class="form-control"
                                              id="text-deskripsi-berita2">{!!$data->deskripsi!!}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
