...
@section('title', 'Membuat Visi dan Misi Sekolah')
@section('content')
        ...
        <div class="row">
            <div class="col-lg-12 col-md-8">
                <div class="card py-3 px-3">
                    <form action="{{ url('/admin/visi-dan-misi') }}" enctype="multipart/form-data" method="post">
                        @csrf
                        <div class="mb-3">
                            <label class="form-label" for="basic-default-company">Deskripsi</label>
                            <textarea type="text" name="deskripsi" cols="30" rows="5" class="form-control" id="text-visi-misi"></textarea>
                        </div>
                        <div>
