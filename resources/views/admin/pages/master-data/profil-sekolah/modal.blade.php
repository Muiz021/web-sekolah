                    ...
                    <form action="{{ route('profil-sekolah.store') }}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama" class="form-control" id="basic-default-fullname" placeholder="MTs LANGUAGE INSAN MANDIRI">
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3">
                                <label class="form-label" for="basic-default-company">Deskripsi</label>
                                <textarea id="text-create-profil-sekolah" type="text" name="deskripsi" cols="30" rows="5" class="form-control"></textarea>
                            </div>
                        </div>
                        <div>
            ...
            <div class="modal fade" id="edit-modal-{{ $data->id }}" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ url('admin/profil-sekolah/'.$data->id) }}" enctype="multipart/form-data" method="post">
                            @csrf
                            @method('put')
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="basic-default-company">Deskripsi</label>
                                <textarea id="text-edit-profil-sekolah" type="text" name="deskripsi" cols="30" rows="5" class="form-control">{!!$data->deskripsi!!}</textarea>
                            </div>
                            <div>
                                <button type="submit" class="btn btn-primary d-block ms-auto">Simpan</button>
                            </div>
