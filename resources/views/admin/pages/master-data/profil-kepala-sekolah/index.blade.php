...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    @if ($data == null)
                        <div class="card-header">
                            <div class="pt-3 pt-md-0">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-profil-kepala-sekolah">
                                    <span><i class="bx bx-plus me-sm-2"></i><span class="d-none d-sm-inline-block">Tambah @yield('title')</span></span>
                                </button>
                            </div>
                        </div>
                    @endif
        ...
        @include('admin.pages.master-data.profil-kepala-sekolah.modal')
@endsection
