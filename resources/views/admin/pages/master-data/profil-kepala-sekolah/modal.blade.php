                    ...
                    <form action="{{ route('profil-kepala-sekolah.store') }}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama" class="form-control" id="basic-default-fullname" placeholder="Muiz Muharram">
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3">
            ...
            <div class="modal fade" id="edit-modal-{{ $data->id }}" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ url('admin/profil-kepala-sekolah/'.$data->id) }}" enctype="multipart/form-data" method="post">
                            @csrf
                            @method('put')
                            <div class="mb-3">
