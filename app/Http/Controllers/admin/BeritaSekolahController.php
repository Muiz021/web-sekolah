...
class BeritaSekolahController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        BeritaSekolah::create([
            'judul'  => $request->judul, 'slug' => Str::slug($request->judul, '-'), 'deskripsi' => $request->deskripsi,
            'gambar' => $profileImage,
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->file('gambar')) {
            ...
            $beritaSekolah->update([
                'judul'     => $request->judul, 'slug' => Str::slug($request->judul, '-'),
                'deskripsi' => $request->deskripsi, 'gambar' => $profileImage,
            ]);
        } else {
            $beritaSekolah->update([
                'judul'     => $request->judul, 'slug' => Str::slug($request->judul, '-'),
